...
import * as  momment from "momment"

export async function buyToTarget(targetPrice){
    ...
    // console.log('test', Number(reverse[0]) , Number(reverse[1]))
    ...
    let  m = Math.abs(((busdBalance - targetPrice  * hectaBalance ) * nowPrice ) / (targetPrice  + nowPrice)) * 1.0025
        // target giam 
